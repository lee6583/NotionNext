...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'lee6583', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个热爱技术的码农', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lee6583.github.io/docs-demp/', // 网站地址
